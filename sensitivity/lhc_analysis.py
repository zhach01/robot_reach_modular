...
DEFAULT_PARAMS = [
    ...
    ParameterSpec("Fmax_BIC", 780.0, 0.10, "N", "Biceps Fmax (bi-articular)"),
    ParameterSpec("m1", 1.82, 0.10, "kg", "Humerus mass"),
    ParameterSpec("a61", 0.025, 0.10, "m", "Triceps longus shoulder lever"),
    ParameterSpec("L1", 0.27, 0.10, "m", "Humerus length"),
    ParameterSpec("Fmax_PEC", 699.8, 0.10, "N", "Pectoralis Fmax"),
    ParameterSpec("I1", 0.012, 0.10, "kg·m²", "Moment of inertia"),
    ParameterSpec("l0", 0.10, 0.10, "m", "Optimal fibre length"),
    ParameterSpec("ls", 0.10, 0.10, "m", "Tendon slack length"),
    ParameterSpec("L2", 0.26, 0.10, "m", "Forearm length"),
    ParameterSpec("Lg1", 0.135, 0.10, "m", "Humerus COM distance"),
    ParameterSpec("m2", 1.44, 0.10, "kg", "Forearm mass"),
    ParameterSpec("I2", 0.018, 0.10, "kg·m²", "Forearm inertia"),
    ParameterSpec("Fmax_DEL", 1142.6, 0.10, "N", "Deltoid Fmax"),
    ParameterSpec("Fmax_BRA", 987.3, 0.10, "N", "Brachialis Fmax"),
    ParameterSpec("Fmax_TRI_long", 798.5, 0.10, "N", "Triceps long Fmax"),
    ParameterSpec("Fmax_TRI_lat", 624.3, 0.10, "N", "Triceps lat Fmax"),
