...
try:
    from utils.torch.linear_utils import nnls_small_active_set as _nnls_fn
    _NNLS_IS_TORCH = True
except Exception:  # pragma: no cover
    from utils.numpy.linear_utils import nnls_small_active_set as _nnls_fn  # type: ignore
