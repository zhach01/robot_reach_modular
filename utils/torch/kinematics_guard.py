    ...
    Torch path:
        1) NEW graph-preserving path:
            * Uses the underlying Robot and
              lib.kinematics.torch.HTM_kinematics.geometricJacobian to compute
...
try:
    from lib.kinematics.torch.HTM_kinematics import geometricJacobian as _geomJ_HTM
except ImportError:
    from lib.kinematics.numpy.HTM_kinematics import geometricJacobian as _geomJ_HTM  # noqa: F401
