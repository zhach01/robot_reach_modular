# controller/numpy/anfis_controller.py
# Canonical ANFIS (promoted from v4.1 -- bake-off winner: ~1.0mm vs base 2.2mm;
# the "stabilized" variant diverged). Archived siblings: archive/controller/numpy/anfis_*.py
"""
ANFIS Controller - Corrected Teacher Signal (DROP-IN, PROJECT-SAFE)
