...
NumPy version:
    from tasks.numpy.base_task import CenterOutTask as Task
...
from tasks.torch.base_task import CenterOutTask as Task
...
if __name__ == "__main__":
    ...
    from tasks.torch.center_out import Task as CenterOutTaskTorch
