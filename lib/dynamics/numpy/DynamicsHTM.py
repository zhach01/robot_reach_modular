...
sys.path.append(sys.path[0].replace(r"/lib/dynamics/numpy", r""))

# Libraries
import numpy as np
from lib.kinematics.numpy.HTM_kinematics import *
from lib.dynamics.numpy.Solver import *
from sympy import *
from lib.dynamics.numpy.fastsymp import fast_simplify, tidy, pinv_lr
