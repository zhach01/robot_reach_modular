...
try:
    from lib.kinematics.torch import HTM_kinematics as KIN
except Exception:
    import HTM_kinematics as KIN  # fallback on PYTHONPATH

try:
    from lib.movements.torch import HTM as HTM
except Exception:
    import lib.movements.torch.HTM as HTM  # fallback on PYTHONPATH
