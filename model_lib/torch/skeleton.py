...
- Uses lib.kinematics.torch.HTM_kinematics.{forwardHTM, geometricJacobian}
- Uses lib.dynamics.torch.DynamicsHTM.{inertiaMatrixCOM, centrifugalCoriolisCOM,
  gravitationalCOM}
...
from  lib.torch.Robot import Serial as RobotSerial  # adjust import root if needed
...
class TwoDofArm(Skeleton):
    ...
    where:
        - D, C, g come from lib.dynamics.torch.DynamicsHTM
        - J is lib.kinematics.torch.HTM_kinematics.geometricJacobian (linear x-y rows)
    """
