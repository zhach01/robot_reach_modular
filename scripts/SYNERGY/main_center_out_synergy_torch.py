#!/usr/bin/env python3
# scripts/SYNERGY/main_center_out_synergy_torch.py
# Torch center-out demo for the canonical (full) SynergyController.
...
def main():
    print("[CenterOut Synergy Torch] demo starting ...")
    ...
    try:
        ...
        print(f"[CenterOut Synergy Torch] WARNING: plotting failed: {e}")

    print("[CenterOut Synergy Torch] demo complete.")
    plt.show()
