#!/usr/bin/env python3
# scripts/OSC/main_random_reach_osc_torch.py
# Torch counterpart of main_random_reach_osc.py (operational-space control).
...
def main():
    print("[RandomReach OSC Torch] demo starting ...")
    ...
    try:
        ...
        print(f"[RandomReach OSC Torch] WARNING: plotting failed: {e}")

    print("[RandomReach OSC Torch] demo complete.")
    plt.show()
