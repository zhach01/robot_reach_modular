#!/usr/bin/env python3
# scripts/OSC/main_center_out_osc_torch.py
# Torch center-out operational-space-control demo.
...
def main():
    print("[CenterOut OSC Torch] demo starting ...")
    ...
    try:
        ...
        print(f"[CenterOut OSC Torch] WARNING: plotting failed: {e}")

    print("[CenterOut OSC Torch] demo complete.")
    plt.show()
