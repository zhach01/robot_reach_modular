...
def main():
    print("[CenterOut Tank Torch] demo starting ...")
    ...
    try:
        ...
        print(f"[CenterOut Tank Torch] WARNING: plotting failed: {e}")

    print("[CenterOut Tank Torch] demo complete.")
    plt.show()
