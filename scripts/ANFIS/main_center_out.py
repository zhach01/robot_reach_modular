#!/usr/bin/env python3
# scripts/ANFIS/main_center_out.py  (canonical ANFIS center-out demo)
...
def main():
    print("[CenterOut ANFIS] demo starting ...")
    pc = PlantConfig()
    ...
    # rules persistence (same trained rules as random-reach)
    ...
    print("[CenterOut ANFIS] demo complete.")
    plt.show()
