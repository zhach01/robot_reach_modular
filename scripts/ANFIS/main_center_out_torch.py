#!/usr/bin/env python3
# scripts/ANFIS/main_center_out_torch.py
# Torch center-out demo for the canonical ANFIS controller.
...
def main():
    print("[CenterOut ANFIS Torch] demo starting ...")
    ...
    try:
        ...
        print(f"[CenterOut ANFIS Torch] WARNING: plotting failed: {e}")

    print("[CenterOut ANFIS Torch] demo complete.")
    plt.show()
