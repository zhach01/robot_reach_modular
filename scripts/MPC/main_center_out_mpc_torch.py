#!/usr/bin/env python3
# scripts/MPC/main_center_out_mpc_torch.py
# Torch center-out demo for the canonical NMPC (NonlinearMPCControllerTorch).
...
def main():
    print("[CenterOut NMPC Torch] demo starting ...")
    ...
    try:
        ...
        print(f"[CenterOut NMPC Torch] WARNING: plotting failed: {e}")

    print("[CenterOut NMPC Torch] demo complete.")
    plt.show()
